...
//    public AfricanCountry(int id, String name, double area, String continent, long population, String code, City[] cities, int cityCount){
//        super(id, name, area, continent, population, code, cities, cityCount);
//    }
