...
public class Country {
   ...
   // public int countryCount;
    ...
    public Country(int id, String name, String continent, long population, String code, City[] cities, int count) {
        this.id = id;
        this.name = name;
        //this.area = area;
        this.continent = continent;
...
//    }
    ...
    public void addCity(City city) {
        if (cityCount < cities.length) {
            ...
            System.out.println("Bu ölkəyə artıq şəhər əlavə edilə bilməz.");
        }
    }
