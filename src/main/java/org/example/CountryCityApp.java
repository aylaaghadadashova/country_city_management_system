...
public class CountryCityApp {
    ...
    public static int indexOfCity(String cityName){//Ayla
        for(int i = 0; i<cityCount; i++){
            if(cityName.equals(cities[i].getCityName())) return i;
        }
        return -1;
    }
    ...
    public static void addCountry(){
        ...
        if(choice == 1) {
            ...
            EuropeanCountry europeanCountry = new EuropeanCountry(id, name, continent, population, code, cities, cityCount, isInEuropeanUnion, mainExport, foundingYear);
    ...
    public static void removeCity(){
        ...
        String cityName = cities[cityIndex].getCityName();
    ...
    public static void updateCity() {
        ...
        if (country != null) {
            ...
            for (int i = 0; i < country.getCityCount(); i++) {
                if (countryCities[i].getCityName().equals(name)) {
    ...
    public static void showRates(){
        ...
        if(choice == 1) {
            ...
            double growthRate = city.calculateGrowthRate(prevRevenue, years);
